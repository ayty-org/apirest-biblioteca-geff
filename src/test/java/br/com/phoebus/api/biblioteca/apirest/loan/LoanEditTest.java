...
import br.com.phoebus.api.biblioteca.apirest.loan.service.EditLoanImpl;
...
public class LoanEditTest {

    @Mock
    private LoanRepository repository;

    private EditLoanImpl editLoan;

    @BeforeEach
    void setUp() {
        this.editLoan = new EditLoanImpl(repository);
    }
