...
import br.com.phoebus.api.biblioteca.apirest.user.service.ListUsersServiceImpl;
...
public class ListUserServiceTest {
    ...
    private ListUsersServiceImpl listUsers;

    @BeforeEach
    void setUp() {
        this.listUsers = new ListUsersServiceImpl(repository);
    }
