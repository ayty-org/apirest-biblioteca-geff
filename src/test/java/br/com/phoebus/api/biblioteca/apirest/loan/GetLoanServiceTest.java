...
import br.com.phoebus.api.biblioteca.apirest.loan.service.GetLoanServiceImpl;
...
public class GetLoanServiceTest {
    ...
    private GetLoanServiceImpl getLoan;

    @BeforeEach
    void setUp() {
        this.getLoan = new GetLoanServiceImpl(repository);
    }
