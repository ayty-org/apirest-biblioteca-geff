...
import br.com.phoebus.api.biblioteca.apirest.user.service.DeleteUserServiceImpl;
...
public class DeleteUserServiceTest {
    ...
    private DeleteUserServiceImpl deleteUser;

    @BeforeEach
    void setUp() {
        this.deleteUser = new DeleteUserServiceImpl(repository);
    }
